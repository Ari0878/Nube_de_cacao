...
# ======================== PRECIOS ========================
# Cargar precios desde .env con valores por defecto
PRECIOS = {
    "Americano": float(os.getenv("PRECIO_AMERICANO") or 30.0),
    "Capuchino": float(os.getenv("PRECIO_CAPUCHINO") or 40.0),
    "Latte": float(os.getenv("PRECIO_LATTE") or 45.0),
    "Espresso": float(os.getenv("PRECIO_ESPRESSO") or 25.0),
    "Macchiato": float(os.getenv("PRECIO_MACCHIATO") or 35.0)
}
